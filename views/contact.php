<div class="formulario" id="contacto">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="formulario" class="formulario__form" id="formulario">
        ...
        <div class="formulario__grupo" id="grupo__correo">
            ...
            <p class="formulario__input-error">El correo solo puede contener letras, n&#250;meros, puntos, guiones, guion bajo, debe ser un correo v&#225;lido y no puede estar vac&#237;o</p>
        </div>
        ...
        <div class="formulario__grupo" id="grupo__mensaje">
            ...
            <p class="formulario__input-error">El mensaje debe tener m&#237;nimo 10 caracteres, solo puede contener letras, n&#250;meros, puntos, guiones, guion bajo y no puede estar vac&#237;o</p>
        </div>
